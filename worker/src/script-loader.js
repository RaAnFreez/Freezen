...
async function deliverResolvedFile(request, env, requestId, scriptId, responseMode = "file") {
  ...
  if (!hwid) return deny("HWID_REQUIRED", 403, requestId);
