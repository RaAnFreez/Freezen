...
app.innerHTML = `
  <div class="app-shell">
    ...
    <main class="main">
      <header class="topbar">
        <button class="menu-button" id="menu" aria-label="Open navigation">☰</button>
        <div><p class="eyebrow">CONTROL SYSTEM V3</p><h1 id="page-title">Overview</h1></div>
        <div class="top-actions"><button class="icon-button" aria-label="Notifications">♢</button><div class="avatar">O</div></div>
      </header>
